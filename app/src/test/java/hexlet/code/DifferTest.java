...
public class DifferTest {
    ...
    public void testGenerateJsonStylish() throws Exception {
        String expected = FileReader.readFile(FIX_PATH + "E1.txt");
    ...
    public void testGenerateJsonPlain() throws Exception {
        String expected = FileReader.readFile(FIX_PATH + "E2.txt");
    ...
    public void testGenerateJsonJson() throws Exception {
        String expected = FileReader.readFile(FIX_PATH + "E3.txt");
